...
const menuPageML = [
  { path: '/test/home', name: '首页', component: { render: h => h('div', '首页') } },
  { path: '/test/xtsz/yhgl', name: '用户管理', component: { render: h => h('div', '用户管理') } },
  { path: '/test/xtsz/qxgl', name: '权限管理', component: { render: h => h('div', '权限管理') } },
  { path: '/test/xtsz/rzgl', name: '日志管理', component: { render: h => h('div', '日志管理') } },
  { path: '/test/xtsz/csgl/ceshi1', name: '测试1', component: { render: h => h('div', '测试1') } },
  { path: '/test/xtsz/csgl/ceshi2', name: '测试2', component: { render: h => h('div', '测试2') } },
  { path: '/test/xtsz/csgl/ceshi3', name: '测试3', component: { render: h => h('div', '测试3') } },
  { path: '/test/xtsz/csgl/ceshi4', name: '测试4', component: { render: h => h('div', '测试4') } },
  { path: '/test/xtsz/csgl/ceshi5', name: '测试5', component: { render: h => h('div', '测试5') } },
  { path: '/test/xtsz/csgl/ceshi6', name: '测试6', component: { render: h => h('div', '测试6') } },
  { path: '/test/xtsz/csgl/ceshi7', name: '测试7', component: { render: h => h('div', '测试7') } },
  { path: '/test/xtsz/csgl/ceshi8', name: '测试8', component: { render: h => h('div', '测试8') } },
  { path: '/test/xtsz/csgl/ceshi9', name: '测试9', component: { render: h => h('div', '测试9') } },
  {
    path: '/test/xtsz/csgl/ceshi10',
    name: '测试10',
    component: { render: h => h('div', '测试10') }
  }
]
...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: '/test/menu',
        name: '菜单',
        component: () => import('../views/page/menu/Index.vue'),
        children: menuPageML
      },
      {
        path: '/test/dialog',
  ...
  { path: '/test', redirect: { path: '/', name: 'test' } }
  // {
  //   path: '/component',
  //   name: '组件',
  ...
  //   path: '/test',
  //   name: '首页',
  //   component: () => import('../test-page/Index.vue'),
  //   // redirect: { path: '/yxgb', name: '优秀年轻干部报表' },
  //   children: [
